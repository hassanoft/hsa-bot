...
export default {
  ...
  aliases: [],
  category: 'audio',
  description: 'Convertit un audio en note vocale WhatsApp (ptt).',
  async execute(ctx) {
    ...
    try {
      ...
      await ctx.sock.sendMessage(ctx.chatId, { audio: out, mimetype: 'audio/ogg; codecs=opus', ptt: true }, { quoted: ctx.msg });
    } catch {
